							...
							{#each results.adminPages.exposed as page}
								<li>
									• <a
										...
										class="text-orange-400 hover:underline break-all">{`${page}`}</a
									>
								</li>
							{/each}
						</ul>
					...
					<div class="mb-4">
						...
						<ul class="space-y-1 text-gray-300">
							{#each results.swagger.endpoints as endpoint}
								<li>
									• <a
										href={`https://${domain}${endpoint}`}
										target="_blank"
										rel="noopener noreferrer"
										class="text-orange-400 hover:underline break-all">{`${endpoint}`}</a
									>
								</li>
							{/each}
						</ul>
					...
					<div>
						...
						<div class="grid grid-cols-2 md:grid-cols-3 gap-2">
							{#each results.infrastructure.tech as tech}
								<div class="p-2 bg-[#2b2b2b] rounded-lg">
		...
		<div class="bg-[#202020] rounded-lg p-6" transition:fade>
			...
			<div class="space-y-4">
				...
				{#if results.contentSecurity.policyDetails}
					<div class="bg-[#2b2b2b] p-3 rounded-lg overflow-x-auto">
				...
				<div class="space-y-4">
					...
					{#if results.robotsTxt.exists && results.robotsTxt.contentType === 'text/plain'}
						<div>
							...
							<pre
								class="p-3 bg-[#2b2b2b] rounded-lg overflow-x-auto text-sm whitespace-pre-wrap">{results
							...
							<div>
								...
								<div class="space-y-2">
									{#each results.securityTxt.contacts as contact}
										<div class="p-2 bg-[#2b2b2b] rounded-lg flex items-center gap-2">
							...
							<div>
								...
								<div class="space-y-2">
									{#each results.securityTxt.encryptions as key}
										<div class="p-2 bg-[#2b2b2b] rounded-lg text-sm">
