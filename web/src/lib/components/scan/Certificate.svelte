<script>
	...
	import { Wrench, AlertTriangle, Shield, Calendar, Building2, Award, Key, Hash } from "lucide-svelte";
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <div class="grid grid-cols-[auto,1fr] gap-x-3 text-sm">
                ...
                <span class="text-gray-300">{new Date(results.certificate.validFrom).toLocaleString(undefined, { dateStyle: 'medium', timeStyle: 'short' })}</span>
                <span class="text-gray-400">Valid until:</span>
                <span class="text-gray-300">{new Date(results.certificate.validUntil).toLocaleString(undefined, { dateStyle: 'medium', timeStyle: 'short' })}</span>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="grid grid-cols-[auto,1fr] gap-x-3 text-sm">
                ...
                <span class="text-gray-300">{results.certificate.publicKeyType} ({results.certificate.publicKeyBits} bits)</span>
                ...
                <span class="text-gray-300 font-mono text-xs">{results.certificate.serialNumber || 'Unknown'}</span>
              </div>
            </div>
